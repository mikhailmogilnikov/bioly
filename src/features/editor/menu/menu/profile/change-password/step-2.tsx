...
export function ChangePasswordStep2({
  ...
  const onSubmit = async (_data: OTPFormData) => {
    try {
      ...
      // await verifyOTPAndChangePassword(_data.otp);
    ...
    <div className="flex w-full flex-col items-start justify-start gap-4">
      ...
      >
        ...
        <p className="-mt-2 text-foreground/50 text-sm">
          <Trans>Enter the 6-digit code we sent to your email address.</Trans>
        </p>
        ...
        <button
          ...
          form="change-password-step-2-form"
          type="submit"
        >
