...
const GalleryHorizontalEndIcon = forwardRef<GalleryHorizontalEndIconHandle, GalleryHorizontalEndIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        ...
        >
          <motion.path animate={controls} custom={2} d='M6 5v14' variants={pathVariants} />
          <motion.path animate={controls} custom={1} d='M2 7v10' variants={pathVariants} />
