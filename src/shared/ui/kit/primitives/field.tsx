/** biome-ignore-all lint/a11y/useSemanticElements: <explanat1ion> */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: <explana1tion> */
"use client";
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="relative mx-auto block w-fit bg-background px-2 text-foreground/50"
