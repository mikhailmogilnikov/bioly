...
type MapProps = {
  ...
  styles?: {
    ...
    dark?: MapStyleOption;
    positron?: MapStyleOption;
    darkNolabels?: MapStyleOption;
    lightNolabels?: MapStyleOption;
    positronNolabels?: MapStyleOption;
  };
  /** Map projection type. Use `{ type: "globe" }` for 3D globe view. */
  projection?: MapLibreGL.ProjectionSpecification;
  /** Block all user interactions with the map (pan, zoom, rotate, etc.) */
...
const DefaultLoader = () => (
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="flex gap-1">
      ...
      <span className="size-1.5 animate-pulse rounded-full bg-foreground/60 [animation-delay:150ms]" />
      <span className="size-1.5 animate-pulse rounded-full bg-foreground/60 [animation-delay:300ms]" />
    </div>
  </div>
);
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  const mapStyles = useMemo(
    () => ({
      ...
      positron: styles?.positron ?? defaultStyles.positron,
      darkNolabels: styles?.darkNolabels ?? defaultStyles.darkNolabels,
      lightNolabels: styles?.lightNolabels ?? defaultStyles.lightNolabels,
      positronNolabels:
        styles?.positronNolabels ?? defaultStyles.positronNolabels,
    }),
    [styles]
  ) as Record<string, MapStyleOption>;
  ...
  useEffect(() => {
    ...
    const map = new MapLibreGL.Map({
      ...
      dragPan: !blockInteractions,
      dragRotate: !blockInteractions,
      scrollZoom: !blockInteractions,
      boxZoom: !blockInteractions,
