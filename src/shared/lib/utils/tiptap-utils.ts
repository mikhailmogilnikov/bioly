...
export function findNodePosition(props: {
  ...
  if (hasValidPos) {
    const nodeAtPos = findNodeAtPosition(editor, nodePos ?? 0);
    if (nodeAtPos) {
      return { pos: nodePos ?? 0, node: nodeAtPos };
    }
  }
...
const ATTR_WHITESPACE =
  // biome-ignore lint/suspicious/noControlCharactersInRegex: we need to allow control characters
  /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g;
